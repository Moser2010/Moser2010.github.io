        ...
        for (var c in _objects.markerData.Markers[0]) {
            ...
            for (_i2 = 0; _i2 < _objects.markerData.Markers[0][c].length; _i2++) {
                ...
                if (marker == _b) {
                    ...
                    images.src = _objects.markerData.Markers[0][c][_i2]["Images"][0]['Main Image'];
                    images.style.width = '100%';
                    mySlides[0].src = _objects.markerData.Markers[0][c][_i2]["Images"][1]['Regional Images'][0];
                    sliderImages(c, _i2);
                }
            }
        }
...
function changeSlide(e) {
    for (var c in _objects.markerData.Markers[0]) {
        for (var _i3 = 0; _i3 < _objects.markerData.Markers[0][c].length; _i3++) {
            if (_objects.markerData.Markers[0][c][_i3]["Images"] != undefined) {
                for (var h = 0; h < _objects.markerData.Markers[0][c][_i3]["Images"][1]['Regional Images'].length; h++) {
                    if (e.target.src == _objects.markerData.Markers[0][c][_i3]["Images"][1]['Regional Images'][h]) {
                        mySlides[0].src = _objects.markerData.Markers[0][c][_i3]["Images"][1]['Regional Images'][h];
                    }
                }
            }
        }
